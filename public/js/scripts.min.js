...
!function (e, t) {
    ...
    "use strict";
    var t = [], E = C.document, r = Object.getPrototypeOf, a = t.slice, g = t.concat, u = t.push, i = t.indexOf, n = {},
        o = n.toString, v = n.hasOwnProperty, s = v.toString, l = s.call(Object), m = {}, y = function (e) {
    ...
    S.fn = S.prototype = {
        ...
        for ("boolean" == typeof s && (l = s, s = arguments[a] || {}, a++), "object" == typeof s || y(s) || (s = {}), a === u && (s = this, a--); a < u; a++) if (null != (e = arguments[a])) for (t in e) n = s[t], s !== (r = e[t]) && (l && r && (S.isPlainObject(r) || (i = Array.isArray(r))) ? (i ? (i = !1, o = n && Array.isArray(n) ? n : []) : o = n && S.isPlainObject(n) ? n : {}, s[t] = S.extend(l, o, r)) : void 0 !== r && (s[t] = r));
        return s
    }, S.extend({
    ...
    var p = function (n) {
        var e, p, b, o, i, h, f, g, w, u, l, T, C, s, E, v, a, c, m, S = "sizzle" + 1 * new Date, y = n.document, k = 0,
            r = 0, d = se(), x = se(), D = se(), A = function (e, t) {
                return e === t && (l = !0), 0
            }, N = {}.hasOwnProperty, t = [], _ = t.pop, j = t.push, L = t.push, q = t.slice, O = function (e, t) {
            ...
            R = "\\[" + H + "*(" + P + ")(?:" + H + "*([*^$|!~]?=)" + H + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + P + "))|)" + H + "*\\]",
            M = ":(" + P + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + R + ")*)|.*)\\)|)",
            W = new RegExp(H + "+", "g"), F = new RegExp("^" + H + "+|((?:^|[^\\\\])(?:\\\\.)*)" + H + "+$", "g"),
            $ = new RegExp("^" + H + "*," + H + "*"), B = new RegExp("^" + H + "*([>+~]|" + H + ")" + H + "*"),
            U = new RegExp("=" + H + "*([^\\]'\"]*?)" + H + "*\\]", "g"), z = new RegExp(M),
            X = new RegExp("^" + P + "$"), V = {
                ID: new RegExp("^#(" + P + ")"),
                CLASS: new RegExp("^\\.(" + P + ")"),
                TAG: new RegExp("^(" + P + "|[*])"),
        ...
        function oe(e, t, n, r) {
            ...
            if (!r && ((t ? t.ownerDocument || t : y) !== C && T(t), t = t || C, E)) {
                if (11 !== d && (u = K.exec(e))) if (i = u[1]) {
                    ...
                    if ((i = u[3]) && p.getElementsByClassName && t.getElementsByClassName) return L.apply(n, t.getElementsByClassName(i)), n
                }
                if (p.qsa && !D[e + " "] && (!v || !v.test(e))) {
                    if (1 !== d) f = t, c = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(te, ne) : t.setAttribute("id", a = S), o = (l = h(e)).length; o--;) l[o] = "#" + a + " " + me(l[o]);
        ...
        for (e in p = oe.support = {}, i = oe.isXML = function (e) {
            ...
            return r !== C && 9 === r.nodeType && r.documentElement && (s = (C = r).documentElement, E = !i(C), y !== C && (n = C.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", re, !1) : n.attachEvent && n.attachEvent("onunload", re)), p.attributes = ue(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), p.getElementsByTagName = ue(function (e) {
                return e.appendChild(C.createComment("")), !e.getElementsByTagName("*").length
            }), p.getElementsByClassName = G.test(C.getElementsByClassName), p.getById = ue(function (e) {
            ...
            }, a = [], v = [], (p.qsa = G.test(C.querySelectorAll)) && (ue(function (e) {
                s.appendChild(e).innerHTML = "<a id='" + S + "'></a><select id='" + S + "-\r\\' msallowcapture=''><option selected=''></option></select>", e.querySelectorAll("[msallowcapture^='']").length && v.push("[*^$]=" + H + "*(?:''|\"\")"), e.querySelectorAll("[selected]").length || v.push("\\[" + H + "*(?:value|" + I + ")"), e.querySelectorAll("[id~=" + S + "-]").length || v.push("~="), e.querySelectorAll(":checked").length || v.push(":checked"), e.querySelectorAll("a#" + S + "+*").length || v.push(".#.+[+~]")
            }), ue(function (e) {
            ...
            })), (p.matchesSelector = G.test(c = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)) && ue(function (e) {
                p.disconnectedMatch = c.call(e, "*"), c.call(e, "[s!='']:x"), a.push("!=", M)
            }), v = v.length && new RegExp(v.join("|")), a = a.length && new RegExp(a.join("|")), t = G.test(s.compareDocumentPosition), m = t || G.test(s.contains) ? function (e, t) {
                ...
                return n || (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !p.sortDetached && t.compareDocumentPosition(e) === n ? e === C || e.ownerDocument === y && m(y, e) ? -1 : t === C || t.ownerDocument === y && m(y, t) ? 1 : u ? O(u, e) - O(u, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return l = !0, 0;
            ...
            if ((e.ownerDocument || e) !== C && T(e), t = t.replace(U, "='$1']"), p.matchesSelector && E && !D[t + " "] && (!a || !a.test(t)) && (!v || !v.test(t))) try {
                var n = c.call(e, t);
            ...
            var t, n = [], r = 0, i = 0;
            if (l = !p.detectDuplicates, u = !p.sortStable && e.slice(0), e.sort(A), l) {
                    ...
                    return 1 === g && 0 === v ? function (e) {
                        ...
                        if (c) {
                            ...
                            if (u = [y ? c.firstChild : c.lastChild], y && d) {
                                for (p = (a = (r = (i = (o = (s = c)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === k && r[1]) && r[2], s = a && c.childNodes[a]; s = ++a && s && s[l] || (p = a = 0) || u.pop();) if (1 === s.nodeType && ++p && s === e) {
                                    i[h] = [k, a, p];
                                    break
                                }
                            } else if (d && (p = a = (r = (i = (o = (s = e)[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] || [])[0] === k && r[1]), !1 === p) for (; (s = ++a && s && s[l] || (p = a = 0) || u.pop()) && ((x ? s.nodeName.toLowerCase() !== f : 1 !== s.nodeType) || !++p || (d && ((i = (o = s[S] || (s[S] = {}))[s.uniqueID] || (o[s.uniqueID] = {}))[h] = [k, p]), s !== e));) ;
        ...
        function we(p, h, g, v, m, e) {
            return v && !v[S] && (v = we(v)), m && !m[S] && (m = we(m, e)), ae(function (e, t, n, r) {
                var i, o, s, a = [], u = [], l = t.length, c = e || function (e, t, n) {
                        for (var r = 0, i = t.length; r < i; r++) oe(e, t[r], n);
                        return n
                    }(h || "*", n.nodeType ? [n] : n, []), f = !p || !e && h ? c : be(c, a, p, n, r),
                    d = g ? m || (e ? p : l || v) ? [] : t : f;
                if (g && g(f, d, n, r), v) for (i = be(d, u), v(i, [], n, r), o = i.length; o--;) (s = i[o]) && (d[u[o]] = !(f[u[o]] = s));
                if (e) {
                    if (m || p) {
                        if (m) {
                        ...
                        for (o = d.length; o--;) (s = d[o]) && -1 < (i = m ? O(e, s) : a[o]) && (e[i] = !(t[i] = s))
                    }
        ...
        function Te(e) {
            for (var i, t, n, r = e.length, o = b.relative[e[0].type], s = o || b.relative[" "], a = o ? 1 : 0, u = ye(function (e) {
                return e === i
            }, s, !0), l = ye(function (e) {
                return -1 < O(i, e)
                ...
                return i = null, r
            }]; a < r; a++) if (t = b.relative[e[a].type]) c = [ye(xe(c), t)]; else {
                if ((t = b.filter[e[a].type].apply(null, e[a].matches))[S]) {
                    for (n = ++a; n < r && !b.relative[e[n].type]; n++) ;
                    return we(1 < a && xe(c), 1 < a && me(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(F, "$1"), t, a < n && Te(e.slice(a, n)), n < r && Te(e = e.slice(n)), n < r && me(e))
                }
                c.push(t)
            }
            return xe(c)
        ...
        return ve.prototype = b.filters = b.pseudos, b.setFilters = new ve, h = oe.tokenize = function (e, t) {
            ...
            var n, v, m, y, x, r, i = [], o = [], s = D[e + " "];
            if (!s) {
                for (t || (t = h(e)), n = t.length; n--;) (s = Te(t[n]))[S] ? i.push(s) : o.push(s);
                (s = D(e, (v = o, m = i, y = 0 < m.length, x = 0 < v.length, r = function (e, t, n, r, i) {
                    var o, s, a, u = 0, l = "0", c = e && [], f = [], d = w, p = e || x && b.find.TAG("*", i),
                        h = k += null == d ? 1 : Math.random() || .1, g = p.length;
                    for (i && (w = t === C || t || i); l !== g && null != (o = p[l]); l++) {
                        if (x && o) {
                            for (s = 0, t || o.ownerDocument === C || (T(o), n = !E); a = v[s++];) if (a(o, t || C, n)) {
                                r.push(o);
                                break
                            }
                            i && (k = h)
                    ...
                    if (u += l, y && l !== u) {
                        ...
                        if (e) {
                            if (0 < u) for (; l--;) c[l] || f[l] || (f[l] = _.call(r));
                            f = be(f)
                        }
            ...
            if (n = n || [], 1 === c.length) {
                ...
                for (i = V.needsContext.test(e) ? 0 : o.length; i-- && (s = o[i], !b.relative[a = s.type]);) if ((u = b.find[a]) && (r = u(s.matches[0].replace(Z, ee), J.test(o[0].type) && ge(t.parentNode) || t))) {
                    if (o.splice(i, 1), !(e = r.length && me(o))) return L.apply(n, r), n;
                    break
                }
            }
            return (l || f(e, c))(r, t, !E, n, !t || J.test(e) && ge(t.parentNode) || t), n
        }, p.sortStable = S.split("").sort(A).join("") === S, p.detectDuplicates = !!l, T(), p.sortDetached = ue(function (e) {
    ...
    (S.fn.init = function (e, t, n) {
        ...
        if (n = n || _, "string" == typeof e) {
            ...
            if (r[1]) {
                if (t = t instanceof S ? t[0] : t, S.merge(this, S.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : E, !0)), A.test(r[1]) && S.isPlainObject(t)) for (r in t) y(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
    ...
    S.Callbacks = function (r) {
        ...
        Deferred: function (e) {
                ...
                i = "pending", s = {
                    state: function () {
                            ...
                            return function () {
                                var n = this, r = arguments, e = function () {
                                    ...
                                    if (!(i < u)) {
                                        ...
                                        t = e && ("object" == typeof e || "function" == typeof e) && e.then, y(t) ? a ? t.call(e, l(u, o, H, a), l(u, o, P, a)) : (u++, t.call(e, l(u, o, H, a), l(u, o, P, a), l(u, o, H, o.notifyWith))) : (s !== H && (n = void 0, r = [e]), (a || o.resolveWith)(n, r))
                                    }
                                }, t = a ? e : function () {
                                    try {
                                        e()
                                    } catch (e) {
                                        S.Deferred.exceptionHook && S.Deferred.exceptionHook(e, t.stackTrace), u <= i + 1 && (s !== P && (n = void 0, r = [e]), o.rejectWith(n, r))
                                    }
                                };
                        ...
                        return S.Deferred(function (e) {
                            o[0][3].add(l(0, e, y(r) ? r : H, e.notifyWith)), o[1][3].add(l(0, e, y(t) ? t : H)), o[2][3].add(l(0, e, y(n) ? n : P))
                        }).promise()
                    }, promise: function (e) {
            ...
            var n = arguments.length, t = n, r = Array(t), i = a.call(arguments), o = S.Deferred(), s = function (t) {
                return function (e) {
                    r[t] = this, i[t] = 1 < arguments.length ? a.call(arguments) : e, --n || o.resolveWith(r, i)
                }
            };
            if (n <= 1 && (R(e, o.done(s(t)).resolve, o.reject, !n), "pending" === o.state() || y(i[t] && i[t].then))) return o.then();
            for (; t--;) R(i[t], s(t), o.reject);
            return o.promise()
        }
    });
    ...
    var $ = function (e, t, n, r, i, o, s) {
        ...
        if ("object" === w(n)) for (a in i = !0, n) $(e, t, a, n[a], !0, o, s); else if (void 0 !== r && (i = !0, y(r) || (s = !0), l && (s ? (t.call(e, r), t = null) : (l = t, t = function (e, t, n) {
                return l.call(S(e), n)
    ...
    function ae(e, t) {
        for (var n, r, i = [], o = 0, s = e.length; o < s; o++) (r = e[o]).style && (n = r.style.display, t ? ("none" === n && (i[o] = Y.get(r, "display") || null, i[o] || (r.style.display = "")), "" === r.style.display && re(r) && (i[o] = (f = l = u = void 0, l = (a = r).ownerDocument, c = a.nodeName, (f = se[c]) || (u = l.body.appendChild(l.createElement(c)), f = S.css(u, "display"), u.parentNode.removeChild(u), "none" === f && (f = "block"), se[c] = f)))) : "none" !== n && (i[o] = "none", Y.set(r, "display", n)));
        var a, u, l, c, f;
    ...
    function me(e, t, n, r, i) {
        for (var o, s, a, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if ((o = e[p]) || 0 === o) if ("object" === w(o)) S.merge(d, o.nodeType ? [o] : o); else if (ve.test(o)) {
        ...
        for (f.textContent = "", p = 0; o = d[p++];) if (r && -1 < S.inArray(o, r)) i && i.push(o); else if (l = S.contains(o.ownerDocument, o), s = de(f.appendChild(o), "script"), l && pe(s), n) for (c = 0; o = s[c++];) ce.test(o.type || "") && n.push(o);
        return f
    }
    ...
    S.event = {
        global: {}, add: function (t, e, n, r, i) {
            var o, s, a, u, l, c, f, d, p, h, g, v = Y.get(t);
            if (v) for (n.handler && (n = (o = n).handler, i = o.selector), i && S.find.matchesSelector(ye, i), n.guid || (n.guid = S.guid++), (u = v.events) || (u = v.events = {}), (s = v.handle) || (s = v.handle = function (e) {
                return void 0 !== S && S.event.triggered !== e.type ? S.event.dispatch.apply(t, arguments) : void 0
            }), l = (e = (e || "").match(I) || [""]).length; l--;) p = g = (a = we.exec(e[l]) || [])[1], h = (a[2] || "").split(".").sort(), p && (f = S.event.special[p] || {}, p = (i ? f.delegateType : f.bindType) || p, f = S.event.special[p] || {}, c = S.extend({
                type: p,
                origType: g,
                data: r,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (d = u[p]) || ((d = u[p] = []).delegateCount = 0, f.setup && !1 !== f.setup.call(t, r, h, s) || t.addEventListener && t.addEventListener(p, s)), f.add && (f.add.call(t, c), c.handler.guid || (c.handler.guid = n.guid)), i ? d.splice(d.delegateCount++, 0, c) : d.push(c), S.event.global[p] = !0)
        }, remove: function (e, t, n, r, i) {
            var o, s, a, u, l, c, f, d, p, h, g, v = Y.hasData(e) && Y.get(e);
            if (v && (u = v.events)) {
                for (l = (t = (t || "").match(I) || [""]).length; l--;) if (p = g = (a = we.exec(t[l]) || [])[1], h = (a[2] || "").split(".").sort(), p) {
                    ...
                    s && !d.length && (f.teardown && !1 !== f.teardown.call(e, h, v.handle) || S.removeEvent(e, p, v.handle), delete u[p])
                } else for (p in u) S.event.remove(e, p + t[l], n, r, !0);
                S.isEmptyObject(u) && Y.remove(e, "handle events")
            }
        }, dispatch: function (e) {
            var t, n, r, i, o, s, a = S.event.fix(e), u = new Array(arguments.length),
                l = (Y.get(this, "events") || {})[a.type] || [], c = S.event.special[a.type] || {};
    ...
    function qe(e, t) {
        var n, r, i, o, s, a, u, l;
        if (1 === t.nodeType) {
            if (Y.hasData(e) && (o = Y.access(e), s = Y.set(t, o), l = o.events)) for (i in delete s.handle, s.events = {}, l) for (n = 0, r = l[i].length; n < r; n++) S.event.add(t, i, l[i][n]);
    ...
    function Oe(n, r, i, o) {
        r = g.apply([], r);
        var e, t, s, a, u, l, c = 0, f = n.length, d = f - 1, p = r[0], h = y(p);
        ...
        if (f && (t = (e = me(r, n[0].ownerDocument, !1, n, o)).firstChild, 1 === e.childNodes.length && (e = t), t || o)) {
            for (a = (s = S.map(de(e, "script"), je)).length; c < f; c++) u = e, c !== d && (u = S.clone(u, !0, !0), a && S.merge(s, de(u, "script"))), i.call(n[c], u, c);
            if (a) for (l = s[s.length - 1].ownerDocument, S.map(s, Le), c = 0; c < a; c++) u = s[c], ce.test(u.type || "") && !Y.access(u, "globalEval") && S.contains(l, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? S._evalUrl && S._evalUrl(u.src) : b(u.textContent.replace(Ne, ""), l, u))
        }
        return n
    }
    ...
    S.extend({
        htmlPrefilter: function (e) {
            ...
            var r, i, o, s, a, u, l, c = e.cloneNode(!0), f = S.contains(e.ownerDocument, e);
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || S.isXMLDoc(e))) for (s = de(c), r = 0, i = (o = de(e)).length; r < i; r++) a = o[r], u = s[r], void 0, "input" === (l = u.nodeName.toLowerCase()) && ue.test(a.type) ? u.checked = a.checked : "input" !== l && "textarea" !== l || (u.defaultValue = a.defaultValue);
            if (t) if (n) for (o = o || de(e), s = s || de(c), r = 0, i = o.length; r < i; r++) qe(o[r], s[r]); else qe(e, c);
    ...
    var He = new RegExp("^(" + ee + ")(?!px)[a-z%]+$", "i"), Pe = function (e) {
    ...
    function Me(e, t, n) {
        ...
        return (n = n || Pe(e)) && ("" !== (s = n.getPropertyValue(t) || n[t]) || S.contains(e.ownerDocument, e) || (s = S.style(e, t)), !m.pixelBoxStyles() && He.test(s) && Re.test(t) && (r = a.width, i = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = r, a.minWidth = i, a.maxWidth = o)), void 0 !== s ? s + "" : s
    }
    ...
    !function () {
        function e() {
            if (u) {
                ...
                n = "1%" !== e.top, s = 12 === t(e.marginLeft), u.style.right = "60%", o = 36 === t(e.right), r = 36 === t(e.width), u.style.position = "absolute", i = 36 === u.offsetWidth || "absolute", ye.removeChild(a), u = null
            }
        }
    ...
    var Fe = /^(none|table(?!-c[ea]).+)/, $e = /^--/,
        ...
        Ue = {letterSpacing: "0", fontWeight: "400"}, ze = ["Webkit", "Moz", "ms"], Xe = E.createElement("div").style;
    ...
    function Ye(e, t, n, r, i, o) {
        ...
        for (; s < 4; s += 2) "margin" === n && (u += S.css(e, n + ne[s], !0, i)), r ? ("content" === n && (u -= S.css(e, "padding" + ne[s], !0, i)), "margin" !== n && (u -= S.css(e, "border" + ne[s] + "Width", !0, i))) : (u += S.css(e, "padding" + ne[s], !0, i), "padding" !== n ? u += S.css(e, "border" + ne[s] + "Width", !0, i) : a += S.css(e, "border" + ne[s] + "Width", !0, i));
        return !r && 0 <= o && (u += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - o - u - a - .5))), u
    }

    function Ge(e, t, n) {
        var r = Pe(e), i = Me(e, t, r), o = "border-box" === S.css(e, "boxSizing", !1, r), s = o;
        if (He.test(i)) {
            if (!n) return i;
            i = "auto"
        }
        return s = s && (m.boxSizingReliable() || i === e.style[t]), ("auto" === i || !parseFloat(i) && "inline" === S.css(e, "display", !1, r)) && (i = e["offset" + t[0].toUpperCase() + t.slice(1)], s = !0), (i = parseFloat(i) || 0) + Ye(e, t, n || (o ? "border" : "content"), s, r, i) + "px"
    }
    ...
    S.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var i, o, s, a = X(t), u = $e.test(t), l = e.style;
                if (u || (t = Ve(a)), s = S.cssHooks[t] || S.cssHooks[a], void 0 === n) return s && "get" in s && void 0 !== (i = s.get(e, !1, r)) ? i : l[t];
                "string" == (o = typeof n) && (i = te.exec(n)) && i[1] && (n = oe(e, t, i), o = "number"), null != n && n == n && ("number" === o && (n += i && i[3] || (S.cssNumber[a] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, r)) || (u ? l.setProperty(t, n) : l[t] = n))
            }
        },
        css: function (e, t, n, r) {
            var i, o, s, a = X(t);
            return $e.test(t) || (t = Ve(a)), (s = S.cssHooks[t] || S.cssHooks[a]) && "get" in s && (i = s.get(e, !0, n)), void 0 === i && (i = Me(e, t, r)), "normal" === i && t in Ue && (i = Ue[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i
        }
    }), S.each(["height", "width"], function (e, a) {
        S.cssHooks[a] = {
            get: function (e, t, n) {
                if (t) return !Fe.test(S.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, a, n) : ie(e, Be, function () {
                    return Ge(e, a, n)
                })
            }, set: function (e, t, n) {
                var r, i = Pe(e), o = "border-box" === S.css(e, "boxSizing", !1, i), s = n && Ye(e, a, n, o, i);
                return o && m.scrollboxSize() === i.position && (s -= Math.ceil(e["offset" + a[0].toUpperCase() + a.slice(1)] - parseFloat(i[a]) - Ye(e, a, "border", !1, i) - .5)), s && (r = te.exec(t)) && "px" !== (r[3] || "px") && (e.style[a] = t, t = S.css(e, a)), Qe(0, t, s)
            }
        }
    }), S.cssHooks.marginLeft = We(m.reliableMarginLeft, function (e, t) {
        if (t) return (parseFloat(Me(e, "marginLeft")) || e.getBoundingClientRect().left - ie(e, {marginLeft: 0}, function () {
        ...
        }, "margin" !== i && (S.cssHooks[i + o].set = Qe)
    }), S.fn.extend({
        css: function (e, t) {
    ...
    function it() {
        Ze && (!1 === E.hidden && C.requestAnimationFrame ? C.requestAnimationFrame(it) : C.setTimeout(it, S.fx.interval), S.fx.tick())
    }
    ...
    function ut(o, e, t) {
        var n, s, r = 0, i = ut.prefilters.length, a = S.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (s) return !1;
        ...
        }(c, l.opts.specialEasing); r < i; r++) if (n = ut.prefilters[r].call(l, o, c, l.opts)) return y(n.stop) && (S._queueHooks(l.elem, l.opts.queue).stop = n.stop.bind(n)), n;
    ...
    S.Animation = S.extend(ut, {
        tweeners: {
            ...
            var r, i, o, s, a, u, l, c, f = "width" in t || "height" in t, d = this, p = {}, h = e.style,
            ...
            if ((u = !S.isEmptyObject(t)) || !S.isEmptyObject(p)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = Y.get(e, "display")), "none" === (c = S.css(e, "display")) && (l ? c = l : (ae([e], !0), l = e.style.display || l, c = S.css(e, "display"), ae([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === S.css(e, "float") && (u || (d.done(function () {
                h.display = l
            }), null == l && (c = h.display, l = "none" === c ? "" : c)), h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.always(function () {
                h.overflow = n.overflow[0], h.overflowX = n.overflow[1], h.overflowY = n.overflow[2]
            })), u = !1, p) u || (v ? "hidden" in v && (g = v.hidden) : v = Y.access(e, "fxshow", {display: l}), o && (v.hidden = !g), g && ae([e], !0), d.done(function () {
                for (r in g || ae([e]), Y.remove(e, "fxshow"), p) S.style(e, r, p[r])
            })), u = at(g ? v[r] : 0, r, d), r in v || (v[r] = u.start, g && (u.end = u.start, u.start = 0))
        ...
        fadeTo: function (e, t, n, r) {
            ...
            var i = S.isEmptyObject(t), o = S.speed(e, n, r), s = function () {
            ...
            return "string" != typeof i && (o = e, e = i, i = void 0), e && !1 !== i && this.queue(i || "fx", []), this.each(function () {
                ...
                if (t) r[t] && r[t].stop && s(r[t]); else for (t in r) r[t] && r[t].stop && rt.test(t) && s(r[t]);
                for (t = n.length; t--;) n[t].elem !== this || null != i && n[t].queue !== i || (n[t].anim.stop(o), e = !1, n.splice(t, 1));
                !e && o || S.dequeue(this, i)
            })
        }, finish: function (s) {
            return !1 !== s && (s = s || "fx"), this.each(function () {
                var e, t = Y.get(this), n = t[s + "queue"], r = t[s + "queueHooks"], i = S.timers, o = n ? n.length : 0;
    ...
    }, et = E.createElement("input"), tt = E.createElement("select").appendChild(E.createElement("option")), et.type = "checkbox", m.checkOn = "" !== et.value, m.optSelected = tt.selected, (et = E.createElement("input")).value = "t", et.type = "radio", m.radioValue = "t" === et.value;
    ...
    S.fn.extend({
        ...
        addClass: function (t) {
            ...
            if ((e = gt(t)).length) for (; n = this[u++];) if (i = ht(n), r = 1 === n.nodeType && " " + pt(i) + " ") {
            ...
            return "boolean" == typeof t && s ? t ? this.addClass(i) : this.removeClass(i) : y(i) ? this.each(function (e) {
                ...
                var e, t, n, r;
                if (s) for (t = 0, n = S(this), r = gt(i); e = r[t++];) n.hasClass(e) ? n.removeClass(e) : n.addClass(e); else void 0 !== i && "boolean" !== o || ((e = ht(this)) && Y.set(this, "__className__", e), this.setAttribute && this.setAttribute("class", e || !1 === i ? "" : Y.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
            for (t = " " + e + " "; n = this[r++];) if (1 === n.nodeType && -1 < (" " + pt(ht(n)) + " ").indexOf(t)) return !0;
            return !1
        }
    });
    var vt = /\r/g;
            ...
            option: {
                ...
                get: function (e) {
                    var t, n, r, i = e.options, o = e.selectedIndex, s = "select-one" === e.type, a = s ? null : [],
                        u = s ? o + 1 : i.length;
                    for (r = o < 0 ? u : s ? o : 0; r < u; r++) if (((n = i[r]).selected || r === o) && !n.disabled && (!n.parentNode.disabled || !D(n.parentNode, "optgroup"))) {
    ...
    S.extend(S.event, {
        trigger: function (e, t, n, r) {
            var i, o, s, a, u, l, c, f, d = [n || E], p = v.call(e, "type") ? e.type : e,
                h = v.call(e, "namespace") ? e.namespace.split(".") : [];
            if (o = f = s = n = n || E, 3 !== n.nodeType && 8 !== n.nodeType && !mt.test(p + S.event.triggered) && (-1 < p.indexOf(".") && (p = (h = p.split(".")).shift(), h.sort()), u = p.indexOf(":") < 0 && "on" + p, (e = e[S.expando] ? e : new S.Event(p, "object" == typeof e && e)).isTrigger = r ? 2 : 3, e.namespace = h.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : S.makeArray(t, [e]), c = S.event.special[p] || {}, r || !c.trigger || !1 !== c.trigger.apply(n, t))) {
                if (!r && !c.noBubble && !x(n)) {
                    for (a = c.delegateType || p, mt.test(a + p) || (o = o.parentNode); o; o = o.parentNode) d.push(o), s = o;
                    s === (n.ownerDocument || E) && d.push(s.defaultView || s.parentWindow || C)
                }
                for (i = 0; (o = d[i++]) && !e.isPropagationStopped();) f = o, e.type = 1 < i ? a : c.bindType || p, (l = (Y.get(o, "events") || {})[e.type] && Y.get(o, "handle")) && l.apply(o, t), (l = u && o[u]) && l.apply && V(o) && (e.result = l.apply(o, t), !1 === e.result && e.preventDefault());
                return e.type = p, r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !V(n) || u && y(n[p]) && !x(n) && ((s = n[u]) && (n[u] = null), S.event.triggered = p, e.isPropagationStopped() && f.addEventListener(p, yt), n[p](), e.isPropagationStopped() && f.removeEventListener(p, yt), S.event.triggered = void 0, s && (n[u] = s)), e.result
            }
    ...
    var Dt = /%20/g, At = /#.*$/, Nt = /([?&])_=[^&]*/, _t = /^(.*?):[ \t]*([^\r\n]*)$/gm, jt = /^(?:GET|HEAD)$/,
        Lt = /^\/\//, qt = {}, Ot = {}, It = "*/".concat("*"), Ht = E.createElement("a");
    ...
    Ht.href = xt.href, S.extend({
        ...
        ajax: function (e, t) {
            ...
            var c, f, d, n, p, r, h, g, i, o, v = S.ajaxSetup({}, t), m = v.context || v,
                y = v.context && (m.nodeType || m.jquery) ? S(m) : S.event, x = S.Deferred(),
                b = S.Callbacks("once memory"), w = v.statusCode || {}, s = {}, a = {}, u = "canceled", T = {
            ...
            if (x.promise(T), v.url = ((e || v.url || xt.href) + "").replace(Lt, xt.protocol + "//"), v.type = t.method || t.type || v.method || v.type, v.dataTypes = (v.dataType || "*").toLowerCase().match(I) || [""], null == v.crossDomain) {
                r = E.createElement("a");
                try {
            ...
            if (v.data && v.processData && "string" != typeof v.data && (v.data = S.param(v.data, v.traditional)), Rt(qt, v, t, T), h) return T;
            ...
            function l(e, t, n, r) {
                ...
                }(v, a, T, i), i ? (v.ifModified && ((u = T.getResponseHeader("Last-Modified")) && (S.lastModified[f] = u), (u = T.getResponseHeader("etag")) && (S.etag[f] = u)), 204 === e || "HEAD" === v.type ? l = "nocontent" : 304 === e ? l = "notmodified" : (l = a.state, o = a.data, i = !(s = a.error))) : (s = l, !e && l || (l = "error", e < 0 && (e = 0))), T.status = e, T.statusText = (t || l) + "", i ? x.resolveWith(m, [o, l, T]) : x.rejectWith(m, [T, l, s]), T.statusCode(w), w = void 0, g && y.trigger(i ? "ajaxSuccess" : "ajaxError", [T, v, i ? o : s]), b.fireWith(m, [T, l]), g && (y.trigger("ajaxComplete", [T, v]), --S.active || S.event.trigger("ajaxStop")))
            }
    ...
    var Wt = {0: 200, 1223: 204}, Ft = S.ajaxSettings.xhr();
    m.cors = !!Ft && "withCredentials" in Ft, m.ajax = Ft = !!Ft, S.ajaxTransport(function (i) {
        var o, s;
        if (m.cors || Ft && !i.crossDomain) return {
            send: function (e, t) {
                var n, r = i.xhr();
        ...
        if (n.crossDomain) return {
            send: function (e, t) {
                r = S("<script>").prop({charset: n.scriptCharset, src: n.url}).on("load error", i = function (e) {
    ...
    S.ajaxSetup({
        ...
        if (s || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Ut, "$1" + r) : !1 !== e.jsonp && (e.url += (wt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return o || S.error(r + " was not called"), o[0]
        }, e.dataTypes[0] = "json", i = C[r], C[r] = function () {
            o = arguments
        }, n.always(function () {
            void 0 === i ? S(C).removeProp(r) : C[r] = i, e[r] && (e.jsonpCallback = t.jsonpCallback, Bt.push(r)), o && y(i) && i(o[0]), o = i = void 0
        }), "script"
    }), m.createHTMLDocument = (($t = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === $t.childNodes.length), S.parseHTML = function (e, t, n) {
        return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = E.implementation.createHTMLDocument("")).createElement("base")).href = E.location.href, t.head.appendChild(r)) : t = E), o = !n && [], (i = A.exec(e)) ? [t.createElement(i[1])] : (i = me([e], t, o), o && o.length && S(o).remove(), S.merge([], i.childNodes)));
        var r, i, o
    }, S.fn.load = function (e, t, n) {
        var r, i, o, s = this, a = e.indexOf(" ");
        return -1 < a && (r = pt(e.slice(a)), e = e.slice(0, a)), y(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), 0 < s.length && S.ajax({
            url: e,
            type: i || "GET",
            dataType: "html",
            data: t
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === l && (e.style.position = "relative"), a = c.offset(), o = S.css(e, "top"), u = S.css(e, "left"), ("absolute" === l || "fixed" === l) && -1 < (o + u).indexOf("auto") ? (s = (r = c.position()).top, i = r.left) : (s = parseFloat(o) || 0, i = parseFloat(u) || 0), y(t) && (t = t.call(e, n, S.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + i), "using" in t ? t.using.call(e, f) : c.css(f)
        }
    }, S.fn.extend({
        offset: function (t) {
        ...
        S.cssHooks[n] = We(m.pixelPosition, function (e, t) {
            if (t) return t = Me(e, n), He.test(t) ? S(e).position()[n] + "px" : t
        })
        ...
        S.each({padding: "inner" + s, content: a, "": "outer" + s}, function (r, o) {
            S.fn[o] = function (e, t) {
                ...
                return $(this, function (e, t, n) {
                    var r;
                    return x(e) ? 0 === o.indexOf("outer") ? e["inner" + s] : e.document.documentElement["client" + s] : 9 === e.nodeType ? (r = e.documentElement, Math.max(e.body["scroll" + s], r["scroll" + s], e.body["offset" + s], r["offset" + s], r["client" + s])) : void 0 === n ? S.css(e, t, i) : S.style(e, t, n, i)
                }, a, n ? e : void 0, n)
            }
        })
    ...
    }, S.isArray = Array.isArray, S.parseJSON = JSON.parse, S.nodeName = D, S.isFunction = y, S.isWindow = x, S.camelCase = X, S.type = w, S.now = Date.now, S.isNumeric = function (e) {
        var t = S.type(e);
        return ("number" === t || "string" === t) && !isNaN(e - parseFloat(e))
    }, "function" == typeof define && define.amd && define("jquery", [], function () {
        return S
    });
    var zt = C.jQuery, Xt = C.$;
    return S.noConflict = function (e) {
        return C.$ === S && (C.$ = Xt), e && C.jQuery === S && (C.jQuery = zt), S
    }, e || (C.jQuery = C.$ = S), S
});
var Carousel = function (p) {
    var t = "carousel", s = "bs.carousel", n = "." + s, e = ".data-api", r = p.fn[t],
        i = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0}, a = {
            interval: "(number|boolean)",
            keyboard: "boolean",
            slide: "(boolean|string)",
            pause: "(string|boolean)",
            wrap: "boolean"
        }, h = "next", u = "prev", g = "left", v = "right", m = {
            SLIDE: "slide" + n,
            SLID: "slid" + n,
            KEYDOWN: "keydown" + n,
        ...
        }, l = "carousel", y = "active", x = "slide", b = "carousel-item-right", w = "carousel-item-left",
        T = "carousel-item-next", C = "carousel-item-prev", c = ".active", E = ".active.carousel-item",
        f = ".carousel-item", d = ".carousel-item-next, .carousel-item-prev", S = ".carousel-indicators",
        o = "[data-slide], [data-slide-to]", k = '[data-ride="carousel"]', D = function () {
            function o(e, t) {
                this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(t), this._element = p(e)[0], this._indicatorsElement = p(this._element).find(S)[0], this._addEventListeners()
            }
            ...
            return e.next = function () {
                ...
                e || (this._isPaused = !0), p(this._element).find(d)[0] && (Util.triggerTransitionEnd(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null
            }, e.cycle = function (e) {
                e || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config.interval && !this._isPaused && (this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval))
            }, e.to = function (e) {
                var t = this;
                this._activeElement = p(this._element).find(E)[0];
                var n = this._getItemIndex(this._activeElement);
                if (!(e > this._items.length - 1 || e < 0)) if (this._isSliding) p(this._element).one(m.SLID, function () {
                    return t.to(e)
                }); else {
                ...
                p(this._element).off(n), p.removeData(this._element, s), this._items = null, this._config = null, this._element = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null
                ...
                return this._items = p.makeArray(p(e).parent().find(f)), this._items.indexOf(e)
            }, e._getItemByDirection = function (e, t) {
                var n = e === h, r = e === u, i = this._getItemIndex(t), o = this._items.length - 1;
                if ((r && 0 === i || n && i === o) && !this._config.wrap) return t;
                var s = (i + (e === u ? -1 : 1)) % this._items.length;
                return -1 === s ? this._items[this._items.length - 1] : this._items[s]
            }, e._triggerSlideEvent = function (e, t) {
                var n = this._getItemIndex(e), r = this._getItemIndex(p(this._element).find(E)[0]),
                    i = p.Event(m.SLIDE, {relatedTarget: e, direction: t, from: r, to: n});
                return p(this._element).trigger(i), i
            }, e._setActiveIndicatorElement = function (e) {
                if (this._indicatorsElement) {
                    p(this._indicatorsElement).find(c).removeClass(y);
                    var t = this._indicatorsElement.children[this._getItemIndex(e)];
                    t && p(t).addClass(y)
                }
            }, e._slide = function (e, t) {
                var n, r, i, o = this, s = p(this._element).find(E)[0], a = this._getItemIndex(s),
                    u = t || s && this._getItemByDirection(e, s), l = this._getItemIndex(u), c = Boolean(this._interval);
                if (e === h ? (n = w, r = T, i = g) : (n = b, r = C, i = v), u && p(u).hasClass(y)) this._isSliding = !1; else if (!this._triggerSlideEvent(u, i).isDefaultPrevented() && s && u) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(u);
                    var f = p.Event(m.SLID, {relatedTarget: u, direction: i, from: a, to: l});
                    if (p(this._element).hasClass(x)) {
                        p(u).addClass(r), Util.reflow(u), p(s).addClass(n), p(u).addClass(n);
                        var d = Util.getTransitionDurationFromElement(s);
                        p(s).one(Util.TRANSITION_END, function () {
                            p(u).removeClass(n + " " + r).addClass(y), p(s).removeClass(y + " " + r + " " + n), o._isSliding = !1, setTimeout(function () {
                                return p(o._element).trigger(f)
                            }, 0)
                        }).emulateTransitionEnd(d)
                    } else p(s).removeClass(y), p(u).addClass(y), this._isSliding = !1, p(this._element).trigger(f);
                    c && this.cycle()
                }
            }, o._jQueryInterface = function (r) {
                return this.each(function () {
                    var e = p(this).data(s), t = _objectSpread({}, i, p(this).data());
                    "object" == typeof r && (t = _objectSpread({}, t, r));
                    var n = "string" == typeof r ? r : t.slide;
                    if (e || (e = new o(this, t), p(this).data(s, e)), "number" == typeof r) e.to(r); else if ("string" == typeof n) {
                ...
                if (t) {
                    var n = p(t)[0];
                    if (n && p(n).hasClass(l)) {
                        var r = _objectSpread({}, p(n).data(), p(this).data()), i = this.getAttribute("data-slide-to");
                        i && (r.interval = !1), o._jQueryInterface.call(p(n), r), i && p(n).data(s).to(i), e.preventDefault()
                    }
                }
            }, _createClass(o, null, [{
    ...
    return p(document).on(m.CLICK_DATA_API, o, D._dataApiClickHandler), p(window).on(m.LOAD_DATA_API, function () {
        p(k).each(function () {
            var e = p(this);
            D._jQueryInterface.call(e, e.data())
        })
    }), p.fn[t] = D._jQueryInterface, p.fn[t].Constructor = D, p.fn[t].noConflict = function () {
        return p.fn[t] = r, D._jQueryInterface
    }, D
}($), Util = function (r) {
    var t = "transitionend";
    ...
    return r.fn.emulateTransitionEnd = e, r.event.special[u.TRANSITION_END] = {
        bindType: t,
        delegateType: t,
        handle: function (e) {
...
!function (o) {
    o.fn.niceSelect = function (e) {
        function r(e) {
            ...
            var r = e.next(), t = e.find("option"), n = e.find("option:selected");
            r.find(".current").html(n.data("display") || n.text()), t.each(function (e) {
                var t = o(this), n = t.data("display");
                r.find("ul").append(o("<li></li>").attr("data-value", t.val()).attr("data-display", n || null).addClass("option" + (t.is(":selected") ? " selected" : "") + (t.is(":disabled") ? " disabled" : "")).html(t.text()))
            })
        }
    ...
    $(document).ready(function () {
        ...
        $('select').niceSelect();
        $('#add__button').bind('click',displayForm);
        //grecaptcha.execute();
        // $('#reg__button').on('click',function (e) {
        //
        //     e.preventDefault();
        //
...
var onRegSubmit = function (response) {
    document.getElementById("reg__form").submit(); // send response to your backend service
};
var onAuthSubmit = function (response) {
    document.getElementById("auth__form").submit(); // send response to your backend service
};
var onResSubmit = function (response) {
    document.getElementById("res__form").submit(); // send response to your backend service
};

var submitSelect = function () {
    document.getElementById("sel_form").submit(); // send response to your backend service
};

var  displayForm = function() {
    var columns = JSON.parse($('#fieldList').text());
    var table = $('#tableName').text();

    // var str="<tr> <input type=\"hidden\" name=\"table\" value=\""+table+"\">";
    // for (var i=0;i<columns.length;i++){
    //     var td = `<td><input ${columns[i]=='id'?'readonly':''} name="${columns[i]}" value=""></td>`
    //     str+=td;
    // }
    // str += "<td><button type=\"submit\" name=\"save\">Save</button></td></tr>";
    //
    // $('#table__body').append(str);
    // var form = $(document.createElement("form"));
    // form.attr("action", "/edit");
    // form.attr("method", "post");
    // form.attr("id", "new_form");
    // var tableInput = $(document.createElement("input"));
    // tableInput.attr("type", "hidden");
    // tableInput.attr("name", "table");
    // tableInput.attr("value", table);
    // var tr = $(document.createElement("tr"));
    //
    // tr.append(tableInput);
    // for (var i = 0; i < columns.length; i++) {
    ...
    //         input.attr("readonly","");
    //     }
    //     input.attr("name",columns[i]);
    //     input.attr("value","");
    //     input.attr("form","new_form");
    //
    //     td.append(input);
    //     tr.append(td);
    // }
    ...
    for (var i = 0; i < columns.length; i++) {
        ...
        div.attr("class","row col-3 justify-content-between");
    ...
    saveButton.attr("type","submit");
    saveButton.attr("name","save");
    saveButton.attr("class","col-2 row");
    saveButton.attr("style","margin:10px");
    saveButton.text("Save");
